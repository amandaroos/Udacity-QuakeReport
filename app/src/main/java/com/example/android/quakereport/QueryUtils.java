...
public final class QueryUtils {
     ...
     * @param requestUrl url to earthquake website
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.e(LOG_TAG, "URL created in fetchEarthquakeData: " + url);

        // Perform HTTP request to the URL and receive a JSON response back
        String jsonResponse = null;
        try {
            jsonResponse = makeHttpRequest(url);
            Log.e(LOG_TAG, "jsonResponse received from makeHttpRequest: " + jsonResponse);
        } catch (IOException e) {
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        if (url == null) {
            Log.e(LOG_TAG, "jsonResponse returned early because url was null");
            return jsonResponse;
        }
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                //Adding each earthquake to the array of earthquakes
                earthquakes.add(new Earthquake(magnitude,place,time,website));
            }
